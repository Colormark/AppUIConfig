...
public struct UI {
    ...
    static let Color: Dictionary <String,UIColor> = [
        ...
        "PrimaryLight"   : UIColor(red: 0x49/255, green: 0xBB/255, blue: 0xCD/255, alpha: 1.0),  //主色浅
        ...
        "Black50"     :  UIColor(red: 0xFA/255, green: 0xFA/255, blue: 0xFA/255, alpha: 1.0),    //50为曝光度
        ...
        "Black150"    :  UIColor(red: 0xE6/255, green: 0xE6/255, blue: 0xE6/255, alpha: 1.0),
         ...
         * 黑白透明
         */
        "WhiteAlphaLight"      : UIColor(red: 1, green: 1, blue:1, alpha: 0.88), //浅
        "WhiteUltraAlphaLight" : UIColor(red: 1, green: 1, blue: 1, alpha: 0.32), //很浅
         ...
         * Commons
         */
        "Warning"     :UIColor(red: 0xF3/255, green: 0x7B/255, blue: 0x1D/255, alpha: 1.0), //Orange
        "Success"     :UIColor(red: 0x5E/255, green: 0xB9/255, blue: 0x5E/255, alpha: 1.0), //Green
        "Danger"      :UIColor(red: 0xDD/255, green: 0x51/255, blue: 0x4C/255, alpha: 1.0), //Red
        "Linked"      :UIColor(red: 0x26/255, green: 0x93/255, blue: 0xDD/255, alpha: 1.0), //Blue
        "Default"     :UIColor(red: 0xE6/255, green: 0xE6/255, blue: 0xE6/255, alpha: 1.0), //Gray
